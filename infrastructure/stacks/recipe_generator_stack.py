...
class RecipeGeneratorStack(Stack):
    ...
    def create_secrets(self):
        ...
        self.app_secrets = secretsmanager.Secret(
            ...
            generate_secret_string=secretsmanager.SecretStringGenerator(
                secret_string_template="{}", generate_string_key="placeholder"
            ),
    ...
    def create_lambda_function(self):
        ...
        log_group = logs.LogGroup(
            ...
            retention=logs.RetentionDays(
                int(self.config.get("LOG_RETENTION_DAYS", 14))
            ),
            removal_policy=RemovalPolicy.DESTROY,
        )
    ...
    def create_api_gateway(self):
        ...
        lambda_integration = integrations.HttpLambdaIntegration(
            "LambdaIntegration", self.lambda_function
        )
        ...
        # Add root route
        api.add_routes(
            path="/", methods=[apigwv2.HttpMethod.ANY], integration=lambda_integration
        )
    ...
    def create_cloudfront_distribution(self):
        ...
        certificate = acm.Certificate.from_certificate_arn(
            self, "Certificate", certificate_arn=self.config.get("CERTIFICATE_ARN")
        )
    ...
    def create_route53_record(self):
        ...
        hosted_zone = route53.HostedZone.from_lookup(
            self, "HostedZone", domain_name=self.config.get("DOMAIN_NAME")
        )
    ...
    def create_waf(self):
        ...
        rate_limit_rule = wafv2.CfnWebACL.RuleProperty(
            ...
            action=wafv2.CfnWebACL.ActionProperty(block={}),
        ...
        web_acl = wafv2.CfnWebACL(
            ...
            "WebACL",
            scope="CLOUDFRONT",
            default_action=wafv2.CfnWebACL.ActionProperty(allow={}),
        ...
        # Output WAF ARN
        cdk.CfnOutput(
            self, "WebACLArn", value=web_acl.attr_arn, description="WAF Web ACL ARN"
        )
